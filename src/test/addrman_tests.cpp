...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr3 = ResolveService("250.3.2.2", 8865);
    CService addr4 = ResolveService("250.3.3.3", 8865);
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.2.1", 8865), NODE_NONE);
    ...
    BOOST_REQUIRE(info2);
    BOOST_CHECK_EQUAL(info2->ToString(), "250.1.2.1:8865");
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.251.2.2", 8865), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket_legacy)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.1.1", 8865), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(load_addrman)
{
    ...
    BOOST_CHECK(Lookup("250.7.2.2", addr2, 8865, false));
    BOOST_CHECK(Lookup("250.7.3.3", addr3, 8865, false));
    BOOST_CHECK(Lookup("250.7.3.3"s, addr3, 8865, false));
    BOOST_CHECK(!Lookup("250.7.3.3\0example.com"s, addr3, 8865, false));
